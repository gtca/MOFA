...
#'    \item{\code{Expectations}:}{ expected values of the different variables of the model. Nested list of two levels, accessible by name subsetting: the first level contains the variable names (Z, W, AlphaShW, etc.) and the second level contains the expectation name (E,E2, etc.) }
