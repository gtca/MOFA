...
.updateOldModel <- function(object) {
  ...
  # Update expectations
  object@Expectations$Z <- object@Expectations$Z
  object@Expectations$AlphaShW <- object@Expectations$AlphaShW
  for (view in viewNames(object)) {
    object@Expectations$W[[view]] <- object@Expectations$W[[view]]
    object@Expectations$Tau[[view]] <- object@Expectations$Tau[[view]]
    object@Expectations$Theta[[view]] <- object@Expectations$Theta[[view]]
    object@Expectations$Y[[view]] <- object@Expectations$Y[[view]]
  }
